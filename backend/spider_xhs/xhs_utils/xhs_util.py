...
js = execjs.compile(open(os.path.join(_static_dir, 'xhs_xs_xsc_56.js'), 'r', encoding='utf-8').read())
xray_js = execjs.compile(open(os.path.join(_static_dir, 'xhs_xray.js'), 'r', encoding='utf-8').read())
